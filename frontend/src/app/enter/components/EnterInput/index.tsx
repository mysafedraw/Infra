...
export default function EnterInput() {
  ...
  const handleRoomCodeChange = (e: React.ChangeEvent<HTMLInputElement>) =>
    setRoomCode(Number(e.target.value))

  return (
    <div className="flex bg-primary-600 border-4 border-primary-700 w-2/5 h-28 rounded-xl flex-col justify-center items-center">
      {/* 입력 필드 */}
      <input
        value={roomCode}
